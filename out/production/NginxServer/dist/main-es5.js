(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(login, route) {
                    this.login = login;
                    this.route = route;
                    this.title = 'room-web';
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatBoxComponent = /** @class */ (function () {
                function ChatBoxComponent(login, messageService, route) {
                    this.login = login;
                ...
                ChatBoxComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (param) {
                        var publicKey = param.get('id');
                        return _this.messageService.getRoom(publicKey);
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (result) {
                        _this.room = result;
                        return _this.messageService.getMessages(_this.room.publicKey);
                    })).subscribe(function (result) {
                        result.forEach(function (m) {
                            m.sender = _this.room.participants.find(function (v) { return v.publicKey === m.senderPublicKey; }).name;
                        });
                        _this.messages = result;
                        console.log(_this.room[_this.login.sSession.publicKey]);
                        setTimeout(function () { return window.scrollTo(0, document.documentElement.clientHeight); }, 0);
                    });
                };
                /** 发送消息 */
                ChatBoxComponent.prototype.sendMessage = function (content, inputBoxEl) {
                    var message = this.basicMessageInfo();
                ...
                ChatBoxComponent.prototype.inputText = function (event) {
                ...
                /** 上传文件方法 */
                ChatBoxComponent.prototype.changeFile = function (event) {
                    var _this = this;
                    ...
                    fr.addEventListener('load', function (e) {
                        ...
                        _this.messageService.sendMessage(message, _this.room);
                        _this.messages.push(message);
                    });
                    fr.readAsDataURL(file);
                };
                ChatBoxComponent.prototype.basicMessageInfo = function () {
                    var message = new _models_message_model__WEBPACK_IMPORTED_MODULE_3__["MessageModel"]();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatRoomsComponent = /** @class */ (function () {
                function ChatRoomsComponent(messageService, login, route) {
                    this.messageService = messageService;
                    this.login = login;
                    this.route = route;
                }
                ChatRoomsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var client = this.route.snapshot.queryParamMap.get('local');
                    if (client) {
                    ...
                    this.messageService.getRooms().subscribe(function (result) { return _this.rooms = result; });
                };
                ChatRoomsComponent.prototype.delete = function (rm) {
                    var _this = this;
                    this.messageService.deleteRoom(rm.publicKey).subscribe(function () {
                        _this.ngOnInit();
                    });
                };
                return ChatRoomsComponent;
            }());
            ChatRoomsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateDialogComponent = /** @class */ (function () {
                function CreateDialogComponent(login, messageService, dialogRef) {
                    this.login = login;
                    this.messageService = messageService;
                ...
                CreateDialogComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.login.getPeople().subscribe(function (result) {
                        _this.people = result.filter(function (p) { return p.publicKey !== _this.login.sSession.publicKey; });
                        console.log(_this.login.sSession);
                    });
                };
                CreateDialogComponent.prototype.changeFile = function (event) {
                    var _this = this;
                    var file = event.target.files[0];
                    var fr = new FileReader();
                    fr.addEventListener('load', function (e) {
                        _this.input.img = e.target.result;
                    });
                    fr.readAsDataURL(file);
                };
            ...
            CreateDialogComponent.ctorParameters = function () { return [
                { type: _login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            // 右侧渐变进入
            var switchIn = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('switchIn', [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginService_1;
            var LoginService = LoginService_1 = /** @class */ (function () {
                function LoginService(http) {
                    this.http = http;
                }
                Object.defineProperty(LoginService.prototype, "sSession", {
                    get: function () {
                ...
                LoginService.prototype.getSession = function () {
                    this.http.get(LoginService_1.CLIENT_AD).subscribe(function (result) {
                        LoginService_1.sOnlineServer = result.onlineApi;
                        LoginService_1.sSession = result.session;
                    });
                };
                LoginService.prototype.getPeople = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MessageService = /** @class */ (function () {
                ...
                MessageService.prototype.getMessages = function (publicKey) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                ...
                ToolbarComponent.prototype.openCreateDialog = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_create_dialog_create_dialog_component__WEBPACK_IMPORTED_MODULE_3__["CreateDialogComponent"]);
                    dialogRef.afterClosed().subscribe(function () {
                        _this.createRoom.emit();
                    });
                };
